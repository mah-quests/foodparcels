...
// Still missing.
// 1. Updating the actual_stocklevel_tbl, removing the number of items from the database
// 2. Updating the foodbank_stock_movement_tbl, removing the number of items from the database
