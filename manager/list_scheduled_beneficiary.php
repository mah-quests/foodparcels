              ...
              <div class="col-sm-12">
                <div class="home-tab">
                  ...
                  <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <h4 class="card-title">Distribution List, reference <?php echo $_GET['code'] ?></h4>
                        ...
                        <table class="table table-hover">
                            ...
                            <?php
                                $api_url = $APIBASE."beneficiary_details_exec.php?action=show_distributed_headofhouse&code=".$_GET["code"]."";
